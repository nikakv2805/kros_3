...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__lab3

#else
#  define SWIG_init    init_lab3

#endif
#define SWIG_name    "_lab3"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_factorial(PyObject *self, PyObject *args) {
...
SWIGINTERN PyObject *_wrap_sqrtFloat(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  float arg1 ;
  float val1 ;
  int ecode1 = 0 ;
  ...
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "sqrtFloat" "', argument " "1"" of type '" "float""'");
  } 
  arg1 = (float)(val1);
  result = (float)sqrtFloat(arg1);
...
SWIGINTERN PyObject *_wrap_sqrtDouble(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  double arg1 ;
  double val1 ;
  int ecode1 = 0 ;
  ...
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "sqrtDouble" "', argument " "1"" of type '" "double""'");
  } 
  arg1 = (double)(val1);
  result = (double)sqrtDouble(arg1);
...
SWIGINTERN PyObject *_wrap_shout(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  char *arg1 = (char *) 0 ;
  int res1 ;
  char *buf1 = 0 ;
  ...
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "shout" "', argument " "1"" of type '" "char const *""'");
  }
  arg1 = (char *)(buf1);
  result = (char *)shout((char const *)arg1);
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "sqrtFloat", _wrap_sqrtFloat, METH_O, NULL},
	 { "sqrtDouble", _wrap_sqrtDouble, METH_O, NULL},
	 { "shout", _wrap_shout, METH_O, NULL},
	 { NULL, NULL, 0, NULL }
};
